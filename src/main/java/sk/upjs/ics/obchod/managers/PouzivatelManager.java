...
public class PouzivatelManager implements IPouzivatelManager {

    private final IPouzivatelDao pouzivatelDao;
    private Pouzivatel aktivnyPouzivatel;
    private BooleanProperty prihlaseny = new SimpleBooleanProperty(false);

    public PouzivatelManager(IPouzivatelDao pouzivatelDao) {
